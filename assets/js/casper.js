...
var vm = new Vue({
  ...
  mounted: function() {
    ...
    this.footerBA2URL =
      ...
      this.getDigital(this.footerBA2);
            ...
            function() {
              if (document.getElementById("vcomments") !== null) {
                new Valine({
                  ...
                  el: "#vcomments",
                  emoticon_url:
                    "https://cdn.jsdelivr.net/wp/plugins/wp-editormd/tags/valine/alu",
                  emoticon_list: [
                    "吐.png",
                    "喷血.png",
                    "狂汗.png",
    ...
    if (this.mediumZoom) {
      loadScript(
        ...
        function() {
          mediumZoom(
            document.querySelectorAll(".post-full-content .post-content img")
          );
        }
      );
    }
